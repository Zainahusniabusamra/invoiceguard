...
| Average explanation length | 0 words (just an error code) | ~136 words (with evidence + action) |
...
| case_05 | REVIEW_REQUIRED: QTY_MISMATCH | Yes (116 words) | Yes |
| case_06 | REVIEW_REQUIRED: QTY_MISMATCH, QTY_MISMATCH | Yes (151 words) | Yes |
| case_07 | REVIEW_REQUIRED: PRICE_MISMATCH | Yes (123 words) | Yes |
| case_08 | REVIEW_REQUIRED: PRICE_MISMATCH | Yes (120 words) | Yes |
| case_09 | REVIEW_REQUIRED: UNKNOWN_ITEM | Yes (159 words) | Yes |
| case_10 | REVIEW_REQUIRED: MISSING_FIELD, QTY_MISMATCH | Yes (151 words) | Yes |
